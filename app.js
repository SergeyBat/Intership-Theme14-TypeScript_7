...
class Project {
    constructor(options) {
        ...
        this.daysInTest = 0;
        this.numberOfDevelopersEmployed = 0;
        this.workingProgrammers = [];
...
class Company {
    constructor() {
        this.projectList = [];
        this.projectListForTest = [];
        this.programmerList = [];
        this.listOfCompletedProjects = [];
        this.listOfDelProgrammer = [];
        ...
        this.itemsProject = ['web', 'mobile'];
        this.positionProgrammer = {
            Web: 'web',
            Mobile: 'mobile',
            QA: 'qa'
        };
        this.statusWorkForProgrammer = {
            busy: 'busy',
            free: 'free'
        };
    }
...
class Boss extends Company {
    ...
    giveProjectsToDevelopers() {
        const changeInformationProjectAtWork = (mobProject, freeProgrammer) => {
        ...
        const changeInformation = (typeProject, dep, freeProgrammer) => {
